...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: basePath + '/resources/themes/hotline/common/images/comment/stars.jpg',
		imageAll :basePath + '/resources/themes/hotline/common/images/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	content.find('.rater-star-item').mouseover(function() {
		...
		if (typeof settings.title_format == 'function') {
			$(".scoreInput",jQuery(this).closest( ".tdbox-scort" )).val(current_value);
...
$(function(){
	...
	info_format	: function(value) {
		...
		switch (value) {
			case 1 : 
				info	= '<div class="info-box">1分&nbsp;很差<div> </div></div>';
				break;
			case 2 : 
				info	= '<div class="info-box">2分&nbsp;差<div> </div></div>';
				break;
			case 3 : 
				info	= '<div class="info-box">3分&nbsp;一般<div> </div></div>';
				break;
			case 4 : 
				info	= '<div class="info-box">4分&nbsp;良好<div </div></div>';
				break;
			case 5 : 
				info	= '<div class="info-box">5分&nbsp;优秀<div> </div></div>';
				break;
			default :
				info = value;
				break;
	...
	$('.js-rate-comm').each(function(){
		options.value = $(this).attr("score");
		$(this).rater(options);
	});
});